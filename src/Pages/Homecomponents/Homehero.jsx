...
const Homehero = () => {
  ...
  return (
    <>
      ...
      >
        {/* Static content */}
        <div className="lg:w-[85%] lg:h-[70%] h-auto md:gap-10 gap-4 w-full md:w-[70%]  flex lg:flex-row flex-col justify-center items-center lg:gap-10 p-4">
          ...
          <div className="w-full xs:w-[70%] lg:w-[40%] flex justify-center items-center">
            <div className="w-full h-full bg-[rgb(255,181,36)] rounded-2xl overflow-hidden">
              <Slider {...settings}>
                {data.map((m, index) => (
                  <div
                    key={index}
