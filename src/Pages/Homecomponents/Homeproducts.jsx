...
const TabContent = ({ products }) => (
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
    {products.map((product, index) => (
      <div key={product.id} className="relative rounded overflow-hidden hover:scale-[1.05] transform transition-all duration-500 hover:shadow-lg hover:shadow-gray-700 border-[1px] border-[rgb(255,181,36)]">
        ...
        <div className="p-4">
          ...
          <div className="mt-4 flex justify-between items-center">
            ...
            <a href="#" className="border-[rgb(255,181,36)] transform transition-all duration-300 border-[1px] bg-[rgb(129,196,8)] text-white px-4 py-2 rounded-full text-center hover:bg-blue-600">
        ...
        <ul className="flex flex-wrap justify-center lg:justify-end">
          {Object.keys(products).map((tab) => (
            <li key={tab} className="m-2">
              <button
                className={`px-4 py-2 rounded-full text-gray-900 ${ activeTab === tab ? 'bg-[rgb(255,181,36)] ' : 'bg-gray-200'} hover:bg-blue-300 hover:scale-[1.05] transform transition-all duration-200`}
